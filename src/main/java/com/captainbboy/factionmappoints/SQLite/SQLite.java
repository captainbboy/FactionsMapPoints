...
public class SQLite extends Database {
    ...
    String dbname;
    public SQLite(FactionMapPoints instance){
        super(instance);
        dbname = "database";
    }

    public static String SQLiteCreatePointsTable = "CREATE TABLE IF NOT EXISTS points (" + // make sure to put your table name in here too.
    ...
    public void load() {
        ...
        try {
            ...
            s.executeUpdate(SQLiteCreatePointsTable);
            s.close();
